      ...
      await fetch("https://api.resend.com/emails", {
        ...
        body: JSON.stringify({
          ...
          text: [
            ...
            `Current AI stage: ${body.aiStage || "—"}`,
            "",
            "Our first step is to understand the business problem and determine whether an existing tool, a focused AI Opportunity Audit, an AI Quick Build, or a larger build is the right next move.",
            "",
